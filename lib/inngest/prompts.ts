...
HDFC Bank Ltd (HDFCBANK)  → {"tradingViewSymbol": "BSE:HDFCBANK", "confidence": "high", "reasoning": "HDFC Bank trades on the Bombay Stock Exchange as HDFCBANK"}

Reliance Industries Ltd (RELIANCE)  → {"tradingViewSymbol": "BSE:RELIANCE", "confidence": "high", "reasoning": "Reliance Industries trades on the Bombay Stock Exchange as RELIANCE"}

Infosys Ltd (INFY)  → {"tradingViewSymbol": "BSE:INFY", "confidence": "high", "reasoning": "Infosys trades on the Bombay Stock Exchange as INFY"}

Tata Consultancy Services Ltd (TCS)  → {"tradingViewSymbol": "BSE:TCS", "confidence": "high", "reasoning": "Tata Consultancy Services trades on the Bombay Stock Exchange as TCS"}

ITC Ltd (ITC)  → {"tradingViewSymbol": "BSE:ITC", "confidence": "high", "reasoning": "ITC trades on the Bombay Stock Exchange as ITC"}
